'''Программа работает корректно и выдает правильный результат, 
но в одном месте в коде не соблюдается принципы структурного программирования, 
а именно принцип следования. 
Задача: найти это место и исправить код таким образом, 
чтобы соблюсти принципы структурного программирования.

Требования:
1. Результат выполнения программы должен сохраниться;
2. Оператор break не должно быть;
3. Исправленный код программы нужно написать в комментарии, 
    репозиторий создавать не нужно;
4. В решении нужно выложить полный код программы, 
    а не только исправленное место;'''
