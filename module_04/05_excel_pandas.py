...
excel_data = pandas.read_excel('C:\\Users\\ikaf\\Desktop\\MyProjects\\Project1\\module_04\\data.xlsx', sheet_name='users', engine='openpyxl')
...
if password and user_password == password:
    ...
    sales_data = pandas.read_excel('C:\\Users\\ikaf\\Desktop\\MyProjects\\Project1\\module_04\\data.xlsx', sheet_name='sales', engine='openpyxl')
